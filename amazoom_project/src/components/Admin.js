...
const Admin = () => {
  return (
    <div>
      ...
      <span>
        <Link to="/Products_Admin" className="AdminLink">
          Products
        </Link>
      </span>
      <span>
        <Link to="/Users_Admin" className="AdminLink">
          User Data
        </Link>
      </span>
    </div>
...
export default { EditProducts,  CreateProducts, AdminUsers, AdminProducts, Admin };
